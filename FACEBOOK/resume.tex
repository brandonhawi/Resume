...
the use of PHP in web application development.
...
Worked with a researcher on the University of California, Irvine campus to develop a web application that analyzed 
user's online data using platforms such as Google History, Spotify, and Google Maps. The system used D3js, a JavaScript library for data-driven documents. 
...
C, C++, C\#, Java, SQL, HTML, CSS, JavaScript, Lisp, Prolog, Python, \LaTeX
