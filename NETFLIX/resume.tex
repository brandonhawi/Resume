...
created using C\# and ASP.NET to run Python scripts that access a MSSQL server and using shell scripting to automate other processes.
...
\subsection{Languages}
 ...
 HTML, CSS, JavaScript, React, C, C++, C\#, Java, SQL, Python, \LaTeX
